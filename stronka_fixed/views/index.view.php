...
<main>
    ...
    <div class="home-tabs-wrap">
        <div class="home-tabs page-container">
            <button class="home-tab active" onclick="showHomeTab('tab-promotions', this)">Promotions</button>
            <button class="home-tab" onclick="showHomeTab('tab-trainers', this)">Our Trainers</button>
        </div>
    </div>
...
<script>
function showHomeTab(id, btn) {
    document.querySelectorAll('.home-tab-content').forEach(t => t.classList.remove('active'));
