    ...
    <div class="tp-layout">
        ...
        <div class="tp-left">
            ...
            <div class="card tp-section">
                ...
                <?php else: ?>
                    ...
                    <a href="classes.php" class="btn btn-secondary tp-schedule-link">View Full Schedule</a>
                <?php endif; ?>
            </div>
        ...
        <div class="tp-right">
            ...
            <?php elseif ($role === 'trainer' || $role === 'admin'): ?>
                <div class="card tp-section">
                    <p class="tp-muted-text">Reviews and session booking are available to members only.</p>
                </div>
            <?php else: ?>
                <div class="card tp-section">
                    <p class="tp-muted-text">
